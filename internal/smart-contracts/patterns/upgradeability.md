...
The Integra system uses a hybrid upgradeability model combining:
...
- Layer 0: `AttestationAccessControl` (abstract), `EASAttestationProvider`
...
- [Layer 0 Documentation](../layer0/) - Attestation system architecture
