...
IDocumentTokenizer is the standard interface implemented by all document tokenizers in Integra. It defines the core reserve/claim workflow, view functions, and events for document tokenization.
...
**Path**: `/src/layer3/interfaces/IDocumentTokenizer.sol`
**Version**: 7.0.0

## Related Contracts

- [BaseTokenizer](./BaseTokenizer.md) - Base implementation
