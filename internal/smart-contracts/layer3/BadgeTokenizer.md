...
BadgeTokenizer implements achievement-based document tokenization using ERC-1155 semi-fungible tokens. It enables verifiable credentials, skill badges, and achievement tracking with transferability (unlike soulbound).
...
- **BadgeTokenizer** (transferable): Marketable credentials, collectible badges
- **SoulboundTokenizer** (non-transferable): Identity documents, personal degrees
...
```solidity
// 1. DEPLOY
BadgeTokenizer badgeTokenizer = new BadgeTokenizer();
...
### Related Tokenizers
- **SoulboundTokenizer**: Use for non-transferable credentials (degrees, identity)
- **MultiPartyTokenizer**: Use for multi-party contracts (not achievements)
- **RentalTokenizer**: Use for time-based access (not permanent badges)

## Comparison

### BadgeTokenizer vs SoulboundTokenizer

| Feature | BadgeTokenizer | SoulboundTokenizer |
|---------|-----------------|---------------------|
| Transferable | Yes | No |
...
A:
- **Transferable** (BadgeTokenizer): Marketable skills, verifiable credentials
- **Soulbound** (SoulboundTokenizer): Personal identity, degrees
...
- [BaseTokenizer](./BaseTokenizer.md) - Shared base contract
- [TrustGraphIntegration](./TrustGraphIntegration.md) - Trust credentials
- [SoulboundTokenizer](./SoulboundTokenizer.md) - Non-transferable alternative
