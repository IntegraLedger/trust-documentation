...
SoulboundTokenizer implements non-transferable (soulbound) credentials using ERC-721. Tokens are permanently bound to the recipient and cannot be transferred or sold.
...
## Comparison with OwnershipTokenizer

| Feature | OwnershipTokenizer | SoulboundTokenizer |
|---------|---------------------|---------------------|
...
**Path**: `/src/layer3/SoulboundTokenizer.sol`
**Version**: 7.0.0
...
- [OwnershipTokenizer](./OwnershipTokenizer.md) - Transferable variant
- [BadgeTokenizer](./BadgeTokenizer.md) - Transferable achievements
