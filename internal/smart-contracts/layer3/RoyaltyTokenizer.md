...
RoyaltyTokenizer implements revenue-sharing document tokenization using ERC-1155 semi-fungible tokens. Token amounts represent basis points (10000 = 100%), enabling precise percentage-based revenue splits.
...
```solidity
// 1. DEPLOY
RoyaltyTokenizer royaltyTokenizer = new RoyaltyTokenizer();
...
contract RoyaltyDistributor {
    RoyaltyTokenizer public royaltyTokenizer;
...
- **BaseTokenizer**: Access control, capability verification
...
- **SharesTokenizer**: Use for ownership (not revenue splits)
- **MultiPartyTokenizer**: Use for distinct roles (not percentages)
- **SemiFungibleTokenizer**: Similar ERC-1155 but without 100% enforcement

## Comparison

### RoyaltyTokenizer vs SharesTokenizer

| Feature | RoyaltyTokenizer | SharesTokenizer |
|---------|-------------------|------------------|
...
### RoyaltyTokenizer vs MultiPartyTokenizer

| Feature | RoyaltyTokenizer | MultiPartyTokenizer |
|---------|-------------------|----------------------|
...
- [SharesTokenizer](./SharesTokenizer.md) - Alternative for ownership
