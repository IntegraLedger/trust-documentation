...
**Path**: `/src/layer3/OwnershipTokenizerV7.sol`
**Version**: 7.0.0
**Audited**: Yes (Foundation & Tokenization Security Audit 2024)

## Related Contracts

- [Tokenization Overview](./overview.md) - Tokenization architecture
- [Tokenizer Comparison](./tokenizer-comparison.md) - Choose the right tokenizer
- [SoulboundTokenizerV7](./SoulboundTokenizerV7.md) - Non-transferable variant
