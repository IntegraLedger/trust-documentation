...
The Document Management contracts provide core document identity and resolver composition infrastructure for Integra V7. These contracts separate document identity from service composition, enabling flexible, extensible document management while maintaining immutable identity records.
...
The heart of document management - an immutable, pure document identity registry.
