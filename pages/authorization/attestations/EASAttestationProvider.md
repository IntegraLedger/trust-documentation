...
EASAttestationProvider is the EAS-based implementation of IAttestationProvider with comprehensive 13-step verification. It provides robust attestation verification for the Integra architecture using Ethereum Attestation Service.
...
- **AttestationAccessControl (Foundation)**: Calls verifyCapabilities()
- **EAS Contract**: Fetches attestations
- **CapabilityNamespace (Foundation)**: References capability definitions
...
bytes32 public constant SCHEMA_VERSION = keccak256("INTEGRA_CAPABILITY.0.0");
