...
- **IntegraDocumentRegistry_Immutable (Document Management)**: Document and tokenizer lookup
- **IDocumentTokenizer (Tokenization)**: Token holder verification
- **IEAS (Foundation)**: Attestation verification
- **IntegraMessage (Communication)**: Process hash correlation
