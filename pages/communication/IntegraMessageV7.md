...
IntegraMessageV7 is an event-sourced messaging system for workflow coordination. It enables workflow participants to register messages correlated to workflows using ZK proof-based anti-spam protection.
...
- **IntegraVerifierRegistryV7_Immutable (Foundation)**: ZK proof verifier lookup
...
- Verifier is immutable (registered in Foundation contracts)
...
**Components**:
- `integraHash`: Document identifier (from Document Management)
...
**Parameters**:
- `_verifierRegistry`: IntegraVerifierRegistryV7_Immutable address
...
**Verifier Trust**:
```
1. Verifier registered in IntegraVerifierRegistryV7_Immutable
                ↓
