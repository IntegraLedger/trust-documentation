...
SemiFungibleTokenizer implements semi-fungible token tokenization using ERC-1155. Token IDs represent types/classes, with quantities per type, optimized for scenarios where tokens are grouped into categories (event tickets, game items, limited editions).
...
- Similar to MultiPartyTokenizer but type-focused
...
### 4. Similar to MultiPartyTokenizer
...
```solidity
// 1. DEPLOY
SemiFungibleTokenizer semiFungible = new SemiFungibleTokenizer();
...
### Related Tokenizers
- **MultiPartyTokenizer**: Similar structure, different use case (roles vs types)
- **BadgeTokenizer**: Similar use case (achievements), different focus
- **RoyaltyTokenizer**: Similar standard, different validation (100% requirement)

## Comparison

### SemiFungibleTokenizer vs MultiPartyTokenizer

| Feature | SemiFungibleTokenizer | MultiPartyTokenizer |
|---------|------------------------|---------------------|
...
### SemiFungibleTokenizer vs BadgeTokenizer

| Feature | SemiFungibleTokenizer | BadgeTokenizer |
|---------|------------------------|------------------|
...
**Q: What's the difference vs MultiPartyTokenizer?**
...
**Q: When should I use this vs OwnershipTokenizer?**
...
- [MultiPartyTokenizer](./MultiPartyTokenizer.md) - Similar structure
