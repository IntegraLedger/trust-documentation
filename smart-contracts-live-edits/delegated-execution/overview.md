...
Execution contracts provide the execution infrastructure for the Integra V7 smart contract system. This layer enables gasless operations, meta-transaction relaying, and whitelisted contract execution, abstracting gas costs from end users while maintaining security through strict access controls.

## Architecture Philosophy

Execution contracts follow a **gas abstraction** strategy:
...
Execution contracts for gasless/meta-transactions with whitelisted contract calls.
...
- [Communication Contracts](../layer4/overview.md)
